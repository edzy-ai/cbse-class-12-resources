...
const subjectColorClass = {
  mathematics: 'text-blue-500', physics: 'text-green-500', chemistry: 'text-orange-500',
  biology: 'text-teal-500', english: 'text-orange-500', 'political-science': 'text-purple-500',
  hindi: 'text-pink-500', history: 'text-yellow-500', geography: 'text-green-500',
  economics: 'text-blue-500', accountancy: 'text-indigo-500', 'business-studies': 'text-violet-500',
  sociology: 'text-rose-500', psychology: 'text-violet-500',
  'health-and-physical-education': 'text-teal-500',
  'computer-science': 'text-cyan-500', 'informatics-practices': 'text-sky-500',
}
...
export default function BookList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 12 ${fmt(subject)} – ${fmt(book)}`}
        description={`Browse all ${fmt(book)} chapters for CBSE Class 12 ${fmt(subject)}. Access free AI prompts for every chapter to use with ChatGPT, Gemini, or Claude.`}
      />
      <Navbar />
