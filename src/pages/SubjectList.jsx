...
const subjectMeta = {
  ...
  physics:                         { Icon: FlaskConical, colorClass: 'text-green-500',  bgClass: 'bg-green-50'  },
  chemistry:                       { Icon: FlaskConical, colorClass: 'text-orange-500', bgClass: 'bg-orange-50' },
  biology:                         { Icon: FlaskConical, colorClass: 'text-teal-500',   bgClass: 'bg-teal-50'   },
  english:                         { Icon: Languages,    colorClass: 'text-orange-500', bgClass: 'bg-orange-50' },
  'political-science':             { Icon: Landmark,     colorClass: 'text-purple-500', bgClass: 'bg-purple-50' },
  ...
  history:                         { Icon: Scroll,       colorClass: 'text-yellow-500', bgClass: 'bg-yellow-50' },
  geography:                       { Icon: Landmark,     colorClass: 'text-green-500',  bgClass: 'bg-green-50'  },
  economics:                       { Icon: Calculator,   colorClass: 'text-blue-500',   bgClass: 'bg-blue-50'   },
  accountancy:                     { Icon: Calculator,   colorClass: 'text-indigo-500', bgClass: 'bg-indigo-50' },
  'business-studies':              { Icon: BookMarked,   colorClass: 'text-violet-500', bgClass: 'bg-violet-50' },
  sociology:                       { Icon: Landmark,     colorClass: 'text-rose-500',   bgClass: 'bg-rose-50'   },
  psychology:                      { Icon: PenLine,      colorClass: 'text-violet-500', bgClass: 'bg-violet-50' },
  'computer-science':              { Icon: PenLine,      colorClass: 'text-cyan-500',   bgClass: 'bg-cyan-50'   },
  'informatics-practices':         { Icon: PenLine,      colorClass: 'text-sky-500',    bgClass: 'bg-sky-50'    },
}
...
export default function SubjectList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 12 ${fmt(subject)} Prompts`}
        description={`Explore all ${fmt(subject)} books and chapters for CBSE Class 12. Access free AI prompts for every chapter to use with ChatGPT, Gemini, and Claude.`}
      />
      <Navbar />
      <main className="flex-1">
        <div className="bg-white border-b border-gray-100 px-6 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">CBSE Class 12 {fmt(subject)}</h1>
