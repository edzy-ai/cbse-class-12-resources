...
const subjectConfig = {
  mathematics:                     { Icon: Calculator,   desc: 'Relations, Functions, Calculus, Algebra, Probability and more.' },
  physics:                         { Icon: FlaskConical, desc: 'Electrostatics, Magnetism, Optics, Modern Physics and more.' },
  chemistry:                       { Icon: FlaskConical, desc: 'Solid State, Solutions, Electrochemistry, Organic Chemistry and more.' },
  biology:                         { Icon: FlaskConical, desc: 'Reproduction, Genetics, Evolution, Ecology and more.' },
  english:                         { Icon: Languages,    desc: 'Flamingo, Vistas — prose, poetry, and supplementary readers.' },
  'political-science':             { Icon: Landmark,     desc: 'Contemporary World Politics and Politics in India.' },
  hindi:                           { Icon: BookMarked,   desc: 'Aroh, Vitan, Antra, Antral — all Hindi books.' },
  'health-and-physical-education': { Icon: HeartPulse,   desc: 'Physical education, yoga, sports and health.' },
  history:                         { Icon: Scroll,       desc: 'Themes in Indian History Parts I, II and III.' },
  geography:                       { Icon: Landmark,     desc: 'Fundamentals of Human Geography and India People and Economy.' },
  economics:                       { Icon: Calculator,   desc: 'Introductory Macroeconomics and Microeconomics.' },
  accountancy:                     { Icon: Calculator,   desc: 'Accountancy Part I and Part II.' },
  'business-studies':              { Icon: BookMarked,   desc: 'Business Studies Parts I and II.' },
  sociology:                       { Icon: Landmark,     desc: 'Indian Society and Social Change and Development in India.' },
  psychology:                      { Icon: PenLine,      desc: 'Psychology — all chapters.' },
  'computer-science':              { Icon: PenLine,      desc: 'Computer Science — all chapters.' },
  'informatics-practices':         { Icon: PenLine,      desc: 'Informatics Practices — all chapters.' },
}
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title="CBSE Class 12 AI Study Prompts"
        description="Free chapter-wise AI prompts for CBSE Class 12 across all subjects. Use with ChatGPT, Gemini, or Claude to study smarter and score better."
      />
      <Navbar />
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 items-start">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-3">
                  CBSE Class 12<br />Most Effective<br />
                  <span className="text-4xl lg:text-5xl font-bold text-blue-600 leading-tight tracking-tight">
                    Prompts
                  </span>
                </h1>
                <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-md">
                  Free chapter-wise NCERT prompts, structured by subject, book, and chapter for CBSE Class 12 students
                </p>
